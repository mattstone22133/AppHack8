...
public class BackgroundHandler {
	...
	public void render(SpriteBatch batch, float charX, float charY) {
		...
		// leftTile
		batch.draw(TextureHolder.grass, (grassTileCenter.x - GRASSTILEOFFSET) - (GRASSTILEOFFSET * 2), grassTileCenter.y - GRASSTILEOFFSET, 0, 0, GRASSTILESIZE * TextureHolder.grass.getWidth(),
				GRASSTILESIZE * TextureHolder.grass.getHeight());
		// rightTile
		batch.draw(TextureHolder.grass, (grassTileCenter.x - GRASSTILEOFFSET) + (GRASSTILEOFFSET * 2), grassTileCenter.y - GRASSTILEOFFSET, 0, 0, GRASSTILESIZE * TextureHolder.grass.getWidth(),
				GRASSTILESIZE * TextureHolder.grass.getHeight());
		// topTile
		batch.draw(TextureHolder.grass, grassTileCenter.x - GRASSTILEOFFSET, (grassTileCenter.y - GRASSTILEOFFSET) + (GRASSTILEOFFSET * 2), 0, 0, GRASSTILESIZE * TextureHolder.grass.getWidth(),
				GRASSTILESIZE * TextureHolder.grass.getHeight());
		// bottomTile
		batch.draw(TextureHolder.grass, grassTileCenter.x - GRASSTILEOFFSET, (grassTileCenter.y - GRASSTILEOFFSET) - (GRASSTILEOFFSET * 2), 0, 0, GRASSTILESIZE * TextureHolder.grass.getWidth(),
				GRASSTILESIZE * TextureHolder.grass.getHeight());
		...
		// topLeft
		batch.draw(TextureHolder.grass, (grassTileCenter.x - GRASSTILEOFFSET) - (GRASSTILEOFFSET * 2), (grassTileCenter.y - GRASSTILEOFFSET) + (GRASSTILEOFFSET * 2), 0, 0, GRASSTILESIZE * TextureHolder.grass.getWidth(),
				GRASSTILESIZE * TextureHolder.grass.getHeight());
		// topRight
		batch.draw(TextureHolder.grass, (grassTileCenter.x - GRASSTILEOFFSET) + (GRASSTILEOFFSET * 2), (grassTileCenter.y - GRASSTILEOFFSET) + (GRASSTILEOFFSET * 2), 0, 0, GRASSTILESIZE * TextureHolder.grass.getWidth(),
				GRASSTILESIZE * TextureHolder.grass.getHeight());
